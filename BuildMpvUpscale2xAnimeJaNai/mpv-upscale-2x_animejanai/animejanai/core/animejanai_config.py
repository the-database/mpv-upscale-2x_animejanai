...
def read_config():
    ...
    conf = {'slot_1001': {'chain_1': {'max_fps': 31.0,
                        ...
                        'models': [{'name': '2x_AnimeJaNai_HD_V3_Compact-fp16',
            ...
            'chain_2': {'max_fps': 31.0,
                        ...
                        'min_px': 0.0,
                        'min_resolution': '0x0',
                        'models': [{'name': '2x_AnimeJaNai_SD_V1beta34_Compact-fp16',
                                    'resize_factor_before_upscale': 100.0,
                                    'resize_height_before_upscale': 0.0}],
                        'rife': False},
            'chain_3': {'max_fps': 61.0,
                        ...
                        'min_px': 0.0,
                        'min_resolution': '0x0',
                        'models': [{'name': '2x_AnimeJaNai_HD_V3_SuperUltraCompact-fp16',
                                    'resize_factor_before_upscale': 100.0,
                                    'resize_height_before_upscale': 0.0}],
                        'rife': False},
            'profile_name': 'Quality'},
             'slot_1002': {'chain_1': {'max_fps': 31.0,
                                    ...
                                    'min_px': 921600.0,
                                    'min_resolution': '1280x720',
                                    'models': [{'name': '2x_AnimeJaNai_HD_V3_UltraCompact-fp16',
                                                'resize_factor_before_upscale': 100.0,
                                                'resize_height_before_upscale': 0.0}],
                                    'rife': False},
                        'chain_2': {'max_fps': 31.0,
